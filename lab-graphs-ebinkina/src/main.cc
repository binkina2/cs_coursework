...
/*
   ...
   std::cout << "Number of classes needed before CS 120 starting at non-eisting CS 225 : "
             << cs.Solve("CS 225", "CS 120") << std::endl;
 */

 psyc.Print();

//Solve(PSYC 100,PSYC 238)
//     std::cout << "Solve(PSYC 100,PSYC 465)" << psyc.Solve("PSYC 100", "PSYC 465") << std::endl;


std::string a[] = {"fake", "PSYC 100", "PSYC 216", "PSYC 465", "PSYC 238", "PSYC 210", "PSYC 413", "PSYC 311"};
 for(std::string s : a) {
   for(std::string x : a) {
     std::cout << "Solve(" << s << ',' << x <<")" << psyc.Solve(s, x) << std::endl;
   }
 }
...
/*
 std::cout
   ...
   std::cout
       << "Number of classes needed before PSYC 216 starting at PSYC 210 : "
       << psyc.Solve("PSYC 210", "PSYC 216") << std::endl;
*/
