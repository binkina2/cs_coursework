...
*/
  ...
  SeamCarver v_carver( image );
  std::cout << "*** ORIIGINAL IMAGE ***:\n";
  v_carver.PrintImage();


  v_carver.RemoveVerticalSeam();

  std::cout << "*** AFTER REMOVING V-SEAM ***:\n";
  v_carver.PrintImage();


  v_carver.RemoveHorizontalSeam();

  std::cout << "*** AFTER REMOVING H-SEAM ***:\n";
  v_carver.PrintImage();
